...
export default function LandingPage({ onStart }: LandingPageProps) {
  // Texts for each step
  const steps: string[] = [
    "במבחן זה אתם תתבקשו להחליט אם מילה המופיעה על המסך היא אמיתית או לא",
    "במידה והמילה אמיתית, לחצו על החץ הימני במקלדת או על הכפתור עליו רשום ״נכון״",
    "במידה והמילה אינה אמיתית, לחצו על החץ השמאלי במקלדת או על הכפתור עליו רשום ״לא נכון״",
    "לאחר בחירתכם, תופיע מיד מילה חדשה. המשיכו כך עד לסיום המבחן",
    "?מוכנים"
  ];
